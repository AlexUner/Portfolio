...
;#GENERAL TEXT 	
		...
		InputBoxTextInd db "Now the index",0
		InputBoxTextCnt db "And now the QUANTITY!",0
;#OUTPUT		
		Format1         db "Output line: ",0
		Format2         db 13,"Do you want to enter new data?",0
;#VARIABLES		
...
s2:
	...
	push	offset ind
	call	StrToInt
	cmp    	ind, ebx                  	; empty check
	ja     	errIndexInput	  			
	
s3:
	mov    	mode, 3
	invoke 	InputBox, addr InputBoxTextCnt, addr InputBoxName, addr SecondString
	test   	eax, eax                 	
	jz 	   	errValueInput  				
	push	offset SecondString
	push	offset cnt
